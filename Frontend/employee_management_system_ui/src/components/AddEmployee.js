    ...
    <div className='flex max-w-2xl mx-auto shadow border-b'>
        <div className='px-8 py-8'>
            ...
            <div className='items-center justify-center h-14 w-full my-4'>
                <lable className="block text-gray-600 text-sm font-normal">First Name</lable>
                <input type="text" 
                name='firstName' 
            ...
            <div className='items-center justify-center h-14 w-full my-4'>
                <lable className="block text-gray-600 text-sm font-normal">Last Name</lable>
                <input type="text" 
                name='lastName' 
            ...
            <div className='items-center justify-center h-14 w-full my-4'>
                <lable className="block text-gray-600 text-sm font-normal">Email</lable>
                <input type="Email" 
                name='email' 
